...
describe MagicSeven do
  ...
  describe '#subtract_four' do
    it 'returns 0' do
      input = 4
      result = game.subtract_four input
  ...
  describe '#divide_by_two' do
    it 'returns 2' do
      input = 4
      result = game.divide_by_two input
  ...
  describe '#subtract_random_number' do
    it 'returns 4' do
      random_number = 9
      random_game = described_class.new(random_number)
      num = 13
      result = random_game.subtract_random_number(num)
  ...
  describe '#play' do
    context 'when the random number is 9' do
      ...
      it 'will return 7' do
        random_number = 9
        new_game = described_class.new random_number
